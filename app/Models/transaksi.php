...
class transaksi extends Model
{
    ...
    protected $fillable = ['uuid', 'status', 'nama_customer', 'email_customer', 'notelp_customer', 'alamat_customer', 'promosi_id', 'total_harga', 'tracking_number', 'downpayment_amount', 'remaining_payment', 'tanggal_transaksi', 'jam_transaksi', 'user_id', 'status_downpayment', 'pelunasan_amount','status_pickup', 'tanggal_pelunasan', 'jam_pelunasan', 'tanggal_pickup', 'jam_pickup'];
